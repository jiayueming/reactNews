...
const MenuItemGroup = Menu.ItemGroup;
 ...
 class MonileHeader extends React.Component{
    constructor(){
        super()
        this.state = {
            current:'top',
                    ...
                    <Tabs Type="card" onChange={this.callback.bind(this)}>
                        ...
                        <TabPane tab="注册" key="2">
                            <Form horizontal onSubmit={this.handleSubmit.bind(this)}>
                                ...
                                <FormItem label="确认密码">
                                    <Input type="password" placeholder="请在此输入你的密码" {...getFieldProps('r_confirmPassword')}/>
                                </FormItem>
...
export default MonileHeader = Form.create({})(MonileHeader)